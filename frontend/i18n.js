...
const TRANSLATIONS = {
    en: {
        ...
        "credentialsLinkHint": "Send this one-time link to somebody who needs an account: they choose their own password and take their own photo, while the ID and the role stay yours to decide. Only a worker, a moallem or an off-office worker can be created this way.",
        ...
        "notesInboxHint": "Requests and reports from workers, moallems and off-office workers. Your reply appears on the worker's phone.",
        "notesFilterAll": "All",
        ...
        "shiftHoursEditTitle": "Edit worked hours",
        "shiftHoursEditWorker": "Worker",
        "shiftHoursEditRecorded": "Currently recorded",
        "shiftHoursEditLabel": "Corrected hours",
        "shiftHoursEditNoteLabel": "Reason (optional)",
        "shiftHoursEditNoteHint": "e.g. punch pair covered a mid-shift errand",
        "shiftHoursEditHint": "The corrected figure becomes the recorded and the approved hours, and the overtime is re-derived from it. The edit is written to the audit trail under your name.",
        "shiftHoursEditConfirm": "Save correction",
        "shiftHoursEditInvalid": "Enter hours between 0 and 24.",
